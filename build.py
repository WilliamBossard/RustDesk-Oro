...
def build_flutter_windows(version, features, skip_portable_pack):
    ...
    system2(f'mv "../../{flutter_build_dir_2}/rustdesk.exe" "../../{flutter_build_dir_2}/Assistance Oro.exe" || true')
    system2(
        f'python3 ./generate.py -f ../../{flutter_build_dir_2} -o . -e "../../{flutter_build_dir_2}/Assistance Oro.exe"')
    os.chdir('../..')
